if (title != "null") {	
	...
	var xScale = string_width(title)+(margin*2);
	...
	//Draw Text
	var txtLenght = string_width(title)/global.resWAspect;
	var txtColor = textColor;
	draw_text_color(scr_gui(positionX+(margin/global.resWAspect)/*+txtLenght*/,"x"),
					scr_gui(positionY+(spriteHeight/2),"y"), title, txtColor, txtColor, txtColor, txtColor, 1);
}
